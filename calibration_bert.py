...
class NerProcessor(DataProcessor):
    ...
    def get_train_examples(self, data_dir):
        ...
        return self._create_examples(
            self._read_tsv(os.path.join(data_dir, "train_dev.tsv")), "train")
    ...
    def get_labels(self):
        return ["O", "B-Disposition", "I-Disposition",  "B-NoDisposition", "I-NoDisposition", "B-Undetermined", "I-Undetermined", "[CLS]", "[SEP]"]
